            ...
            <div className="grid grid-cols-1 md:flex gap-6 ">
                ...
                <div className="flex flex-col md:h-screen md:sticky top-10 gap-6 order-first md:order-last md:ml-auto">
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            <button type="submit" name="_method" value="create" disabled={isAdding} className="px-4 py-2 bg-blue-400 text-white rounded flex justify-center hover:bg-blue-600">
