                ...
                <div className="px-4 mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-3 gap-10">
                        <div className="flex flex-col border border-stone-700 rounded-xl p-6">
                            ...
                            <p className="pt-3 text-stone-400">Add books and authors to your library and keep track of your favorite quotes.</p>
                        </div>
                        <div className="flex flex-col border border-stone-700 rounded-xl p-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" className="text-blue-400 w-12 h-12 mb-1">
                            ...
                            <p className="pt-3 text-stone-400">Easily keep track of the notes you take while reading and link them to memorable quotes.</p>
                        </div>
                        <div className="flex flex-col border border-stone-700 rounded-xl p-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" className="text-blue-400 w-12 h-12 mb-1">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
                            </svg>
                            <h4 className="text-stone-50 font-semibold text-xl">Share your thoughts</h4>
                            <p className="pt-3 text-stone-400">Share your favorite quotes from what you're reading and add your own comments.</p>
                        </div>
                    </div>
                </div>
            </div>
