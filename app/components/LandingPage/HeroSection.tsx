                ...
                <div className="flex flex-col lg:flex-row gap-4 mx-auto px-4 max-w-6xl">
                    <div className="">
                        ...
                        <div className="flex gap-4">
                            ...
                            <Link to="/join">
                                <button className="flex tems-center gap-2 font-bold text-stone-200 border-2 border-stone-200 bg-stone-900 rounded-3xl px-4 py-2 hover:bg-stone-50  hover:text-blue-600 transition-all ease-in-out">
                                    <p>Watch a Demo</p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
