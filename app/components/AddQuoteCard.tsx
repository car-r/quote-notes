...
export default function AddQuoteCard() {
    return (
        <Link to="/quotes/new" className="flex p-4 border border-stone-800 outline-dashed bg-stone-800 rounded-md text-stone-300/60 hover:text-blue-400 hover:scale-105 justify-center items-center">
