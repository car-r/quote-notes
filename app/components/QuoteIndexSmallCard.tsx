...
export default function QuoteIndexSmallCard({quote}: any) {
    return (
        <div className="p-4 h-40 border border-stone-800 bg-stone-800 rounded-md text-stone-300/60 hover:ring-2 hover:ring-blue-400 hover:text-stone-100">
